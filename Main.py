...
Average7 = np.average(Square7,axis=0); colorAverage7 = np.average(Average7,axis=0); print('Average =',colorAverage7)
Average8 = np.average(Square8,axis=0); colorAverage8 = np.average(Average8,axis=0); print('Average =',colorAverage8)
Average9 = np.average(Square9,axis=0); colorAverage9 = np.average(Average9,axis=0); print('Average =',colorAverage9)
Average10 = np.average(Square10,axis=0); colorAverage10 = np.average(Average10,axis=0); print('Average =',colorAverage10)
